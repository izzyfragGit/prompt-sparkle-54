...
import { Compass, Brain, MessageCircle, ArrowRight, TrendingUp, Users, Zap } from "lucide-react";
...
const valueProps = [
  {
    ...
    description:
      "Vision full-funnel, de la notoriété à la performance. Pilotage de budgets jusqu'à 17M€, arbitrage multi-leviers, conseil stratégique auprès des directions C-level.",
  },
  {
    icon: Users,
    title: "Agence & conseil senior",
    description:
      "20 ans dans l'écosystème Dentsu et WPP, puis en conseil indépendant (SNOVAE). Interface naturelle entre les équipes marketing, les experts et les partenaires externes.",
  },
  {
    icon: Zap,
    title: "IA appliquée au marketing",
    description:
      "Intégration concrète de l'IA générative dans les processus de conseil et de production. Orchestration LLM, automatisation (Make.com), prompt engineering — une pratique réelle, pas un claim.",
  },
];
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-base text-muted-foreground max-w-2xl mx-auto mb-10">
              20 ans de stratégie digitale en agences (Dentsu, WPP) et en conseil indépendant.
              Un profil de chef d'orchestre : pilotage, coordination d'experts, relation client senior.
              L'IA comme levier de performance réelle, pas comme promesse.
            </p>
          </motion.div>
          ...
          >
            <Link to="/parcours">
              <Button
                size="lg"
                className="bg-primary text-primary-foreground hover:bg-primary/90 font-display text-base px-8 py-6 glow-border"
              >
      ...
      <section className="py-20 px-4 bg-surface/50">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-muted-foreground mb-14 max-w-xl mx-auto">
            Trois axes qui structurent une approche construite sur 20 ans de pratique.
          </p>
            ...
            {valueProps.map((prop, i) => (
              ...
              >
                <div className="glass rounded-xl p-8 h-full">
                  <prop.icon className="h-9 w-9 text-primary mb-5" />
      ...
      <section className="py-24 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-muted-foreground mb-16 max-w-xl mx-auto">
            Choisissez le mode qui vous convient pour découvrir ce profil.
          </p>
          <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              { value: "70", label: "Collaborateurs managés" },
            ].map((stat, i) => (
              <motion.div
                key={stat.label}
